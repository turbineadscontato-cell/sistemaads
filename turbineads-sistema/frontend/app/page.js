      ...
      <div className="w-full max-w-sm">
        <div className="flex items-center gap-2.5 justify-center mb-8">
          <svg viewBox="0 0 24 24" width="30" height="30" fill="none">
            <circle cx="12" cy="12" r="10" stroke="#0f6e7a" strokeWidth="1.6" />
            <path d="M12 12 L12 4.2 A7.8 7.8 0 0 1 18.7 8.3 Z" fill="#0f6e7a" />
            <path d="M12 12 L18.7 15.7 A7.8 7.8 0 0 1 12 19.8 Z" fill="#0f6e7a" opacity=".65" />
            <path d="M12 12 L5.3 15.7 A7.8 7.8 0 0 1 5.3 8.3 Z" fill="#0f6e7a" opacity=".35" />
            <circle cx="12" cy="12" r="2" fill="#eef1f3" />
          </svg>
